...
var vm = new Vue({
    ...
    methods: {
            ...
            options.columns = [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        actions.push(' <a class="btn btn-info btn-xs" href="javascript:void(0)" onclick="vm.updatePassword(\'' + row.userId + '\',\'' + row.loginName + '\')"><i class="fa fa-key"></i>重置</a>');
                        return actions.join("");
                    }
                }
            ];
        ...
        updatePassword(userId, loginName) {
            vm.user = {
                userId: '',
                loginName: '',
                password: '',
